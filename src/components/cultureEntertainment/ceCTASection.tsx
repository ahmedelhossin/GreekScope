...
export default function CTASection({ text, buttonText, href }: { text: string; buttonText: string; href: string }) {
    return (
        <section className="mt-20 text-center">
            ...
            <Link href={href}>
                <button name="" className="px-8 py-3 rounded-full bg-black dark:bg-white dark:text-black text-white font-bold active:scale-95 md:hover:scale-105 transition">
                    {buttonText}
                </button>
            </Link>
        </section>
