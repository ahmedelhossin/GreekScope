...
export default function CeOverviewCards({ cards }: { cards: { title: string, description: string }[] }) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {cards.map((card, i) => (
                <div key={i} className="bg-[#2a2a2a] not-dark:bg-white not-dark:active:bg-yellow-200 not-dark:md:hover:bg-yellow-200 p-8 rounded-2xl active:bg-[#333333] md:hover:bg-[#333333] transition-colors">
